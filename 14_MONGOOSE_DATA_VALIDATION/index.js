...
//  because the required name is absent here
// so we need to handle that exception
async function createCourse(){
    const course = new Course({
        // name  :"Angular Course", //  get  a validation error here
        author : "Mosh Hamidani",
        category:"-", // it will show an error because - is not in the enum
        tags   : [], // this will show error because the arrau has length 0
        isPublished:true, // the price validation depends on here
        // price:15 // we will get a validation error here too

    })

    try{
        // you can use this two line
