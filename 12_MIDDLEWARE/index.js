...
app.use(logger);  // this will print the message

// another builtin middleware is static
// for serving static file from a folder
//  use to serve static content
// from a folder name "public"
app.use(express.static('public'));
app.use(helmet());
app.use(morgan("dev"));


// using third party middleware "helmet" for securing the app
// and use morgan for logging
